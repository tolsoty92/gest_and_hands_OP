...
class HandDetector:
    ...
    def __init__(self, path_to_graph='/home/user/PycharmProjects/Hands and pose gestures recognition/classifiers/tf_hand_detection_model/faster_rcnn.pb'):
    ...
    def tf_box_to_op_box(self, tf_box, padding = 1.4):
